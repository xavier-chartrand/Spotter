...
# SHORT-TERM QUALITY FLAG PARAMETERS
# Test9: "N" based on the number of points to resolve a 1.25s minimal period
# (operator) value for a sampling frequency of 2.5Hz
...
# LONG-TERM QUALITY FLAG PARAMETERS
